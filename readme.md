...
| x.509 Certificates | This code shows how to establish a Workload Identity Pool that uses x.509 certificates for authentication. In this example, the certificates are generated by Google's Certificate Authority Service (CAS) | https://github.com/dreardon/workload_identity_certificates |
